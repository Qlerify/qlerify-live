...
const Bubble = ({ children }: { children: React.ReactNode }) => (
  <div className="flex justify-end">
    <div className="max-w-[85%] bg-stone-900 text-white px-3 py-2 rounded-2xl rounded-tr-md text-sm">{children}</div>
  </div>
)
...
const ToolResult = ({ block }: { block: ChatBlock }) => {
  ...
  return (
    <details className={`text-[11px] ${tone} border rounded px-2 py-1 my-1`}>
