...
const DEFAULT_PAGE_SIZE: Record<string, number> = { list: 25, rows: 10 }
const pageSizesFor = (tab: string) => PAGE_SIZES[tab] || PAGE_SIZES.list!
...
const pref = <T,>(k: string, fallback: T): T => {
  try {
...
const normPageSize = (n: unknown, tab: string) => {
